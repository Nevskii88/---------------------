...
$experience = [ 
 ...
 'description' => 'Практический опыт показывает, что новая модель организационной деятельности создаёт предпосылки качественно новых шагов для системы обучения кадров, соответствующей насущным потребностям!'
    ],
    [
 'name' => 'Дизайнер', 
 'date' => 'aug 2018 - jun 2021',
 'description' => 'Значимость этих проблем настолько очевидна, что начало повседневной работы по формированию позиции влечет за собой процесс внедрения и модернизации соответствующих условий активизации'
    ],
];
?>
<!DOCTYPE html>
    ...
    <div class="w3-row-padding">
      ...
      <div class="w3-twothird">
        ...
        <div class="w3-контейнер w3-карта w3-белый">
          <h2 class="w3-text-grey w3-padding-16"><я
